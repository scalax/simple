...
/*sealed trait Number1 extends Core2 {
  override def input(num2: => Core2): Core2
}
case class Number1S(tail: Number1) extends Number1 {
  override def input(num2: => Core2): Core2 = num2.input(tail)
}
case object Number1T extends Number1 {
  override def input(num2: => Core2): Core2 = num2
}

sealed trait Number2 extends Core2 {
  override def input(num1: => Core2): Core2
}
case class Number2S(tail: Number2) extends Number2 {
  override def input(num1: => Core2): Core2 = num1.input(tail)
}
