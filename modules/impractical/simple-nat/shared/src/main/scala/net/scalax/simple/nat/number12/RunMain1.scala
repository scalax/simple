...
object RunMain1 extends App {
  ...
  for {
    ...
    lazy val numPositive2: Core2 = num1(i2, numZero2)
    lazy val numZero2: Core2 = Core2 { other =>
      tag2 = tag2 + 1
      numPositive2(other)
    }
    ...
    val result2: BigDecimal = {
      tag1 = 0
      tag2 = 0
      try {
        numPositive2(() => numPositive1)
      } catch {
        case e: StackOverflowError =>
      }
      BigDecimal(tag2) / BigDecimal(tag1)
    ...
    val result3: BigDecimal = {
      tag1 = 0
      tag2 = 0
      try {
        numPositive1(() => numZero2)
      } catch {
        case e: StackOverflowError =>
      }
      BigDecimal(tag2) / BigDecimal(tag1)
    ...
    val result5: BigDecimal = {
      tag1 = 0
      tag2 = 0
      try {
        numZero1(() => numPositive2)
      } catch {
        case e: StackOverflowError =>
      }
      BigDecimal(tag2) / BigDecimal(tag1)
    ...
    val result6: BigDecimal = {
      tag1 = 0
      tag2 = 0
      try {
        numPositive2(() => numZero1)
      } catch {
        case e: StackOverflowError =>
      }
      BigDecimal(tag2) / BigDecimal(tag1)
