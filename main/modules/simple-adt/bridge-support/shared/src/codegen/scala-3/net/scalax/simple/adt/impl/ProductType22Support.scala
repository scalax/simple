...
object Product22Gen {
  def gen[
    ...
    appender: ProductType22Appender[Append1, AppendPositive1, AppendZero1, Append2, AppendPositive2, AppendZero2, S3Support.Func[
      _
    ], S3Support.Append11, S3Support.Zero, M3],
