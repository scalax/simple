...
def option1(iData: I1): this.NatModelType = ADTData.success(iData)
        ...
        override def apply[ParamType, S <: AdtExtension](a: ParamType)(implicit b: ADTData[this.NatModelTypeFunction[ParamType], S with ADTTypeParameterFetch.type]): NatModelType = {
