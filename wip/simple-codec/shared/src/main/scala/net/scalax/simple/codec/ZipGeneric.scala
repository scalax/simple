...
object ZipGeneric {
  ...
  class ToListGenericApply[F[_[_]]] {
    def derived(basedInstalled: BasedInstalled[F]): ZipGeneric[F] = fromOther(basedInstalled.decode2222)

    def fromOther(o1: ToDecoderGeneric2222[F]): ZipGeneric[F] = new ZipGeneric[F] {
