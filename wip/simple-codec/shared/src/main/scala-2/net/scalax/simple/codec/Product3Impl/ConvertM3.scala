...
object ConvertM3Impl {
  trait M3FType[M1[_], M2[_], M3[_]] extends SimpleProductX.NotHList.FType {
    override type toF[T] = M1[T]
    override type Next   = ConvertM2Impl.M2FType[M2, M3]
  }

  trait InputType3[T1, T2, T3] extends SimpleProductX.NotHList.InputType {
  ...
  object TypeGen {
    ...
    ): SimpleProductX.NotHList.TypeGen[
      ({ type TA[U <: SimpleProductX.NotHList.InputType] = M2[U#toItem, U#AndThen#toItem, U#AndThen#AndThen#toItem] })#TA,
      M3FType[
        M1,
        M3,
        M4
  ...
  object AppendMonad {
    ...
    ): SimpleProductX.NotHList.AppendMonad[
      ({ type TA[U <: SimpleProductX.NotHList.InputType] = M2[U#toItem, U#AndThen#toItem, U#AndThen#AndThen#toItem] })#TA
    ] =
      new SimpleProductX.NotHList.AppendMonad[
        ({ type TA[U <: SimpleProductX.NotHList.InputType] = M2[U#toItem, U#AndThen#toItem, U#AndThen#AndThen#toItem] })#TA
      ] {
        override def zip[
          A <: SimpleProductX.NotHList.InputType,
          B <: SimpleProductX.NotHList.InputType
        ](
        ...
        override def to[A <: SimpleProductX.NotHList.InputType, B <: SimpleProductX.NotHList.InputType](
    ...
    def to2[M2[_, _, _]](
      append: SimpleProductX.NotHList.AppendMonad[
        ({ type TA[U <: SimpleProductX.NotHList.InputType] = M2[U#toItem, U#AndThen#toItem, U#AndThen#AndThen#toItem] })#TA
      ]
      ...
      override def to[A, B, C, S, T, U](
        ...
        append.to[InputType3[A, B, C], InputType3[S, T, U]](m1)(
          new SimpleProductX.NotHList.Mapper[InputType3[A, B, C], InputType3[S, T, U]] {
            override def map(ia: A): S        = in1(ia)
            override def reverseMap(ib: S): A = in4(ib)
            override def nextMapper: SimpleProductX.NotHList.Mapper[ConvertM2Impl.InputType2[B, C], ConvertM2Impl.InputType2[T, U]] =
              new SimpleProductX.NotHList.Mapper[ConvertM2Impl.InputType2[B, C], ConvertM2Impl.InputType2[T, U]] {
                override def map(ia: B): T        = in2(ia)
                override def reverseMap(ib: T): B = in5(ib)
                override def nextMapper: SimpleProductX.NotHList.Mapper[ConvertM1Impl.InputType1[C], ConvertM1Impl.InputType1[U]] =
                  new SimpleProductX.NotHList.Mapper[ConvertM1Impl.InputType1[C], ConvertM1Impl.InputType1[U]] {
    ...
    object Appender {
      def to3[F[_[_]]](append: SimpleProductX.NotHList.Appender[F]): SimpleProduct3.Appender[F] = new SimpleProduct3.Appender[F] {
        override def toHList[M3[_, _, _], M1[_], M2[_], M4[_]](
          ...
          val appendMonad: SimpleProductX.NotHList.AppendMonad[
            ({ type TA[U <: SimpleProductX.NotHList.InputType] = M3[U#toItem, U#AndThen#toItem, U#AndThen#AndThen#toItem] })#TA
          ] =
