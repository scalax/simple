...
object xxbb {
  ...
  def main(arr: Array[String]): Unit = {
    ...
    implicit val setter: Setter[UModel]                    = Setter[UModel].build(implicit m => m.generic)
    ...
    println(modelListGetter.output[ContextI#IdF](value))
    println(modelListGetter.output[ContextI#EmptyTagF](noneFiller.instance))
    ...
    val map2 = modelGetToMap.output[ContextI#EmptyTagF](noneFiller.instance)
    ...
    val setResult2 = modelSetterFromMap.set[ContextI#EmptyTagF](map2)
