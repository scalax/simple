...
object Number {
  ...
  val number1S: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 =>
        ghdmzsk(num2 =>
          ghdmzsk(num3 =>
            ghdmzsk(tail => AA(() => head().inputGHDMZSK(num1()).inputGHDMZSK(num2()).inputGHDMZSK(num3()).inputGHDMZSK(tail())))
          )
        )
      )
    )
  val number1T: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 =>
        ghdmzsk(num2 =>
          ghdmzsk(num3 => ghdmzsk(tail => num1().inputGHDMZSK(num2()).inputGHDMZSK(num3()).inputGHDMZSK(tail()).inputGHDMZSK(head())))
        )
      )
    )
  val number3S: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 =>
        ghdmzsk(num2 =>
          ghdmzsk(num3 => ghdmzsk(tail => tail().inputGHDMZSK(head()).inputGHDMZSK(num1()).inputGHDMZSK(num2()).inputGHDMZSK(num3())))
        )
      )
    )
  val number3T: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 =>
        ghdmzsk(num2 =>
          ghdmzsk(num3 =>
            ghdmzsk(tail => BB(() => num1().inputGHDMZSK(num2()).inputGHDMZSK(num3()).inputGHDMZSK(tail()).inputGHDMZSK(head())))
          )
        )
      )
    )
