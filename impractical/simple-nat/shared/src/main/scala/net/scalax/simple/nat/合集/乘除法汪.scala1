...
object 乘除法汪 {
  ...
  def main1(arr: Array[String]): Unit = {
    ...
    val num2GHDMZSK: ghdmzsk = 统计.gen(positive = 合集.s1, zero = 合集.s4)(positiveLen = num2.Parent, zeroLen = num2.Sub)
    val num3GHDMZSK: ghdmzsk = 统计.gen(positive = 合集.s4, zero = 合集.s5)(positiveLen = num3.Parent, zeroLen = num3.Sub)
