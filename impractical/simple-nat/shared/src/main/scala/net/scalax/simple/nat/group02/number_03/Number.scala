...
object Number {
  ...
  val number1S: ghdmzsk = ghdmzsk(head =>
    ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(tail => AA(() => head().inputGHDMZSK(num1()).inputGHDMZSK(num2()).inputGHDMZSK(tail())))))
  )
  val number2T: ghdmzsk = ghdmzsk(head =>
    ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(tail => num1().inputGHDMZSK(num2()).inputGHDMZSK(tail()).inputGHDMZSK(head()))))
  )
  val number2S: ghdmzsk = ghdmzsk(head =>
    ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(tail => tail().inputGHDMZSK(head()).inputGHDMZSK(num1()).inputGHDMZSK(num2()))))
  )
  val number2U: ghdmzsk = ghdmzsk(head =>
    ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(tail => BB(() => num1().inputGHDMZSK(num2()).inputGHDMZSK(tail()).inputGHDMZSK(head())))))
  )
