...
object Number {
  ...
  val number1S: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(num3 => ghdmzsk(num4 => ghdmzsk(tail => AA(() => head()(num1)(num2)(num3)(num4)(tail)))))))
    )
  val number1T: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(num3 => ghdmzsk(num4 => ghdmzsk(tail => num1()(num2)(num3)(num4)(tail)(head))))))
    )
  val number3S: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(num3 => ghdmzsk(num4 => ghdmzsk(tail => tail()(head)(num1)(num2)(num3)(num4))))))
    )
  val number3T: ghdmzsk =
    ghdmzsk(head =>
      ghdmzsk(num1 => ghdmzsk(num2 => ghdmzsk(num3 => ghdmzsk(num4 => ghdmzsk(tail => BB(() => num1()(num2)(num3)(num4)(tail)(head)))))))
    )
