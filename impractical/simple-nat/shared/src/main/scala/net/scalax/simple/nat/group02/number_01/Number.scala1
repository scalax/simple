...
object Number {
  ...
  val number1S: ghdmzsk = ghdmzsk(num1 => ghdmzsk(num2 => AA(() => num1().inputGHDMZSK(num2()))))
  val number1T: ghdmzsk = ghdmzsk(num1 => ghdmzsk(num2 => num2().inputGHDMZSK(num1())))
  val number2S: ghdmzsk = ghdmzsk(num1 => ghdmzsk(num2 => BB(() => num2().inputGHDMZSK(num1()))))
