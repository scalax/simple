...
object 加减法汪 {
  ...
  def main(arr: Array[String]): Unit = {
    ...
    val num2: Int            = 68
    val num3: Int            = 349
    val num1GHDMZSK: ghdmzsk = 合集.gen(合集.nums.s3, 合集.nums.s7, num1)
    val num2GHDMZSK: ghdmzsk = 合集.gen(合集.nums.s3, 合集.nums.s6, num2)
    val num3GHDMZSK: ghdmzsk = 合集.gen(合集.nums.s5, 合集.nums.s1, num3)
